...
```text
Last write time: 2026-06-25 after the gallery animation and locked-folder polish pass
Size: regenerated by :app:assembleDebug
Build result: passed via :app:assembleDebug after the latest animation, prefetch, skeleton, and locked-folder changes
